...
class DynamicCascadeRoIHead(CascadeRoIHead):
    ...
    #     super(DynamicCascadeRoIHead, self).__init__(
    ...
    def forward_train(self,
        ...
        for i in range(self.num_stages):
            ...
            curr_bbox_head = self.bbox_head[i]
            # print('Tham s? beta là: ', curr_bbox_head.loss_bbox.beta)
            ...
            try:
                ...
                if len(self.iou_history) % update_iter_interval == 0:
                    new_iou_thr = self.update_hyperparameters(rcnn_train_cfg, bbox_assigner)
                # print('Giá tr? IoU m?i:', new_iou_thr)
            except:
                pass
    ...
    def update_hyperparameters(self, rcnn_train_cfg, bbox_assigner):
        ...
        """
        new_iou_thr = max(rcnn_train_cfg.dynamic_rcnn.initial_iou,
        ...
        #     new_beta = curr_bbox_head.loss_bbox.beta
        # else:
        #     new_beta = min(rcnn_train_cfg.dynamic_rcnn.initial_beta,
        #                    np.median(self.beta_history))
        # self.beta_history = []

        # curr_bbox_head.loss_bbox.beta = new_beta
